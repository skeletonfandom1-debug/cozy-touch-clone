    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative rounded-full">
          ...
          {totalItems > 0 && (
            <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-pink text-white">
              {totalItems}
            </Badge>
          )}
        </Button>
            ...
            <>
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <Button
                  ...
                  className="w-full bg-pink-gradient hover:opacity-90 text-white"
                  size="lg"
